...
IF(WIN32)
  ...
  set(GFLAGS_SHARED_LIB_DLL "${GFLAGS_INSTALL_DIR}/bin/gflags.dll")
  set(BUILD_GFLAGS_SHARED_LIBS ON)
  set(BUILD_GFLAGS_STATIC_LIBS OFF)
ELSE(WIN32)
  set(GFLAGS_LIBRARIES "${GFLAGS_INSTALL_DIR}/lib/libgflags.so" CACHE FILEPATH "GFLAGS_LIBRARIES" FORCE)
  set(BUILD_COMMAND $(MAKE) --silent)
  set(INSTALL_COMMAND $(MAKE) install)
  set(BUILD_GFLAGS_SHARED_LIBS OFF)
  set(BUILD_GFLAGS_STATIC_LIBS ON)
ENDIF(WIN32)
...
ExternalProject_Add(
    ...
    CMAKE_ARGS      -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
                    ...
                    -DBUILD_SHARED_LIBS=${BUILD_GFLAGS_SHARED_LIBS}
                    -DBUILD_STATIC_LIBS=${BUILD_GFLAGS_STATIC_LIBS}
